...
export function DashboardSidebar() {
  ...
  return (
    <Sidebar variant="inset" className="bg-muted border-r" collapsible="icon">
                        ...
                        {item.title === "Inventory" &&
                          ...
                          lowStockCount > 0 && (
                            <Badge
                              ...
                              className="ml-auto h-5 min-w-5 flex items-center justify-center rounded-full text-[10px] font-bold font-mono bg-white hover:bg-white text-brand-main-900 border-0 data-[active=false]:bg-brand-main-900 data-[active=false]:text-white">
