...
const navigationItems = [
  {
    ...
    url: "/dashboard",
    icon: Home,
    roles: ["SuperAdmin", "Manager", "SalesPerson"] as const,
  },
  {
    title: "Analytics",
...
export function DashboardSidebar() {
  ...
  return (
    <Sidebar
      variant="inset"
      className="bg-lunar-green-50 border-lunar-green-200"
      collapsible="icon"
    >
      ...
      <SidebarContent>
        ...
        <SidebarSeparator className="bg-lunar-green-200" />
        ...
        <SidebarMenu>
          ...
          <SidebarMenuItem className="flex items-center gap-3 px-2 mb-3 group-data-[collapsible=icon]:hidden">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-xs text-lunar-green-600">{user.role}</span>
            </div>
          </SidebarMenuItem>
