...
interface CheckoutDialogProps {
  ...
  tax: number
  total: number
  onCompleteSale: (paymentMethod: "cash" | "card" | "digital", shouldShowReceipt?: boolean) => void
}
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-lunar-green-800">Complete Sale</DialogTitle>
          <DialogDescription className="text-lunar-green-600">
            Review the order details and select a payment method to complete the sale.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
            ...
            <RadioGroup value={paymentMethod} onValueChange={(value) => setPaymentMethod(value as any)}>
              <div className="flex items-center space-x-2 p-3 border border-lunar-green-200 rounded-lg">
                ...
                <Label htmlFor="card" className="flex items-center gap-2 cursor-pointer flex-1">
                  ...
                  <span className="text-lunar-green-700">Credit/Debit Card</span>
                </Label>
              </div>
              <div className="flex items-center space-x-2 p-3 border border-lunar-green-200 rounded-lg">
          ...
          <div className="space-y-3">
            <h3 className="font-medium text-lunar-green-800">Receipt Options</h3>
            <div className="flex items-center space-x-2 p-3 border border-lunar-green-200 rounded-lg">
              <input
                type="checkbox"
                id="generate-receipt"
              ...
              />
              <Label htmlFor="generate-receipt" className="cursor-pointer text-lunar-green-700">
