  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-lunar-green-600 mt-1">Manage your store settings and preferences</p>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <Card className="border-lunar-green-200">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-2">
              <Label htmlFor="storeName" className="text-lunar-green-700">
                Store Name
              </Label>
              <Input
                id="storeName"
            ...
            <div className="grid gap-2">
              <Label htmlFor="storeAddress" className="text-lunar-green-700">
                Store Address
              </Label>
              <Input
                id="storeAddress"
            ...
            <div className="grid gap-2">
              <Label htmlFor="taxRate" className="text-lunar-green-700">
                Tax Rate (%)
              </Label>
              <Input
                id="taxRate"
        ...
        <Card className="border-lunar-green-200">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-lunar-green-700">Enable Notifications</Label>
                <p className="text-sm text-lunar-green-600">Receive alerts for low stock and sales</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-lunar-green-600">Automatically backup data daily</p>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-lunar-green-600">Switch to dark theme</p>
              </div>
        ...
        <div className="flex justify-end">
          <Button className="bg-lunar-green-600 hover:bg-lunar-green-700 text-white">Save Settings</Button>
        </div>
      </div>
    </div>
  )
